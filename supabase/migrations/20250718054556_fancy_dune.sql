-- Sample data for Digital Village Website
-- This file contains sample data that can be imported into MySQL database
...
('Administrator', 'admin@desa.go.id', 'YWRtaW4xMjM=');
